...
.text 
	...
	menu:
		...
		mul $t0, $t0, 4 # tem que pular em 4 bytes para pegar o endereco 
	...
	printResut: # imprime o valor presente no registador $a0
		...
		la $a0, ResultMessage # carregando a label ResultMessage no registrador a0 , a0 he dos registradores lidos para executar uma syscall 	
		jal displayMessage
	...
	displayDivite:
		 ...
		 move $a0, $t2
	 	 ...
	 	 jr $t0 # voltar para a funcao anterior
